...
module.exports.setRouter = (app) => {
  ...
  app.post(`${baseUrl}/draw_id`,auth.isAuthorized,betController.draw_id);
  app.post (`${baseUrl}/place_bet`,auth.isAuthorized,betController.place_bet);
  app.post (`${baseUrl}/get_placed_bet`,auth.isAuthorized,betController.get_placed_bet);
  ...
  app.post(`${baseUrl}/get_transaction_history`, auth.isAuthorized,betController.get_transaction_history);

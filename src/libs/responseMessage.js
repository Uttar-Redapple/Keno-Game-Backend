module.exports = {
  ...
  GUEST_FOUND : "Here is your guest",
  GUEST_NOT_FOUND : "Sorry ! no guest is found ",
  BET_AMOUNT_CONFLICT : "Sorry ! please add balance to place bet ",
  BET_HISTORY_FOUND : "Here is your bet history",
  BET_HISTORY_NOT_FOUND: "Sorry ! no bet history is found ",
  INCORRECT_BET_ID : "Sorry ! enter a correct bet id",
  INCORRECT_ID : "Sorry ! enter a correct id", 
  TRANSACTION_HISTORY_FOUND : "Congratulation ! transaction history is found in this id",
  TRANSACTION_HISTORY_NOT_FOUND : "Sorry ! no transaction history is found in this id",
  DRAW_ID_GENERATED : "Draw id is generated",
  countryList: "Country list",
  PAY_OUT_TABLE_DATA_92_FOUND : "payOutTableData92 detail found",
  PAY_OUT_TABLE_DATA_92_NOT_FOUND : "payOutTableData92 detail not found",
